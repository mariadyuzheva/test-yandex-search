...
class ImagesViewerPage(BasePage):
    ...
    def press_next(self):
        ...
        self.browser.find_element(
            *ImagesViewerPageLocators.NEXT_BUTTON).click()

    def press_prev(self):
        """Нажимает кнопку Назад"""
        self.browser.find_element(
            *ImagesViewerPageLocators.PREV_BUTTON).click()
    ...
    def get_current_image_src(self):
        """Возвращает атрибут src для открытой картинки"""
        return self.browser.find_element(
            *ImagesViewerPageLocators.OPENED_IMAGE).get_attribute("src")
